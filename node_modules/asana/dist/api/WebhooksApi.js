...
var WebhooksApi = exports.WebhooksApi = /*#__PURE__*/function () {
  ...
  */
  ...
  return _createClass(WebhooksApi, [{
    ...
    value: function deleteWebhookWithHttpInfo(webhook_gid) {
      var postBody = null;
    ...
    value: function getWebhookWithHttpInfo(webhook_gid, opts) {
      opts = opts || {};
      var postBody = null;
      // verify the required parameter 'webhook_gid' is set
      if (webhook_gid === undefined || webhook_gid === null) {
    ...
    value: function getWebhooksWithHttpInfo(workspace, opts) {
      opts = opts || {};
      var postBody = null;
    ...
    value: function updateWebhookWithHttpInfo(body, webhook_gid, opts) {
      opts = opts || {};
      var postBody = body;
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {

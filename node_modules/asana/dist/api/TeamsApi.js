...
var TeamsApi = exports.TeamsApi = /*#__PURE__*/function () {
  ...
  */
  ...
  return _createClass(TeamsApi, [{
    ...
    value: function createTeamWithHttpInfo(body, opts) {
      opts = opts || {};
      var postBody = body;
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
    ...
    value: function getTeamWithHttpInfo(team_gid, opts) {
      opts = opts || {};
      var postBody = null;
      // verify the required parameter 'team_gid' is set
      if (team_gid === undefined || team_gid === null) {
    ...
    value: function getTeamsForUserWithHttpInfo(user_gid, organization, opts) {
      opts = opts || {};
      var postBody = null;
    ...
    value: function getTeamsForWorkspaceWithHttpInfo(workspace_gid, opts) {
      opts = opts || {};
      var postBody = null;
    ...
    value: function removeUserForTeamWithHttpInfo(body, team_gid) {
      var postBody = body;
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
    ...
    value: function updateTeamWithHttpInfo(body, team_gid, opts) {
      opts = opts || {};
      var postBody = body;
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {

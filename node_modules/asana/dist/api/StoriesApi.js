...
var StoriesApi = exports.StoriesApi = /*#__PURE__*/function () {
  ...
  */
  ...
  return _createClass(StoriesApi, [{
    key: "createStoryForGoalWithHttpInfo",
    value: function createStoryForGoalWithHttpInfo(body, goal_gid, opts) {
      opts = opts || {};
      var postBody = body;
      ...
      var returnType = 'Blob';
      return this.apiClient.callApi('/goals/{goal_gid}/stories', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType);
    }
    ...
    key: "createStoryForGoal",
    value: function createStoryForGoal(body, goal_gid, opts) {
      return this.createStoryForGoalWithHttpInfo(body, goal_gid, opts).then(function (response_and_data) {
    ...
    key: "getStoriesForGoalWithHttpInfo",
    value: function getStoriesForGoalWithHttpInfo(goal_gid, opts) {
      opts = opts || {};
      var postBody = null;
      // verify the required parameter 'goal_gid' is set
      if (goal_gid === undefined || goal_gid === null) {
      ...
      if (this.apiClient.RETURN_COLLECTION) {
        return Collection.fromApiClient(this.apiClient.callApi('/goals/{goal_gid}/stories', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType), this.apiClient, {
      ...
      return this.apiClient.callApi('/goals/{goal_gid}/stories', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType);
    }
    ...
    key: "getStoriesForGoal",
    value: function getStoriesForGoal(goal_gid, opts) {
      // Check if RETURN_COLLECTION is set and return a collection object if it is
      if (this.apiClient.RETURN_COLLECTION) {
        return this.getStoriesForGoalWithHttpInfo(goal_gid, opts);
      }
      return this.getStoriesForGoalWithHttpInfo(goal_gid, opts).then(function (response_and_data) {
        return response_and_data.data;
      });
    }

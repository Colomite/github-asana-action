...
var TimeTrackingEntriesApi = exports.TimeTrackingEntriesApi = /*#__PURE__*/function () {
  ...
  * default to {@link module:ApiClient#instanc
  e} if unspecified.
  */
  function TimeTrackingEntriesApi(apiClient) {
    _classCallCheck(this, TimeTrackingEntriesApi);
  ...
  return _createClass(TimeTrackingEntriesApi, [{
    ...
    value: function deleteTimeTrackingEntryWithHttpInfo(time_tracking_entry_gid) {
      var postBody = null;
    ...
    key: "getTimeTrackingEntriesWithHttpInfo",
    value: function getTimeTrackingEntriesWithHttpInfo(opts) {
      opts = opts || {};
      var postBody = null;
      var pathParams = {};
      var queryParams = {};
      ...
      if (this.apiClient.RETURN_COLLECTION) {
        return Collection.fromApiClient(this.apiClient.callApi('/time_tracking_entries', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType), this.apiClient, {
      ...
      return this.apiClient.callApi('/time_tracking_entries', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType);
    }
    ...
    key: "getTimeTrackingEntries",
    value: function getTimeTrackingEntries(opts) {
      // Check if RETURN_COLLECTION is set and return a collection object if it is
      if (this.apiClient.RETURN_COLLECTION) {
        return this.getTimeTrackingEntriesWithHttpInfo(opts);
      }
      return this.getTimeTrackingEntriesWithHttpInfo(opts).then(function (response_and_data) {
        return response_and_data.data;
      });
    }
    ...
    value: function getTimeTrackingEntriesForTaskWithHttpInfo(task_gid, opts) {
      opts = opts || {};
      var postBody = null;
      // verify the required parameter 'task_gid' is set
      if (task_gid === undefined || task_gid === null) {
    ...
    value: function getTimeTrackingEntryWithHttpInfo(time_tracking_entry_gid, opts) {
      opts = opts || {};
      var postBody = null;
      // verify the required parameter 'time_tracking_entry_gid' is set
      if (time_tracking_entry_gid === undefined || time_tracking_entry_gid === null) {
    ...
    value: function updateTimeTrackingEntryWithHttpInfo(body, time_tracking_entry_gid, opts) {
      opts = opts || {};
      var postBody = body;
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
